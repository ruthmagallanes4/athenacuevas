...
loadImages(imageFolder, 1, numImages)
...
function loadImages(imageFolder, startImage, numImages){
    for (let i = startImage; i < startImage + numImages; i++) {
        ...
        const extensions = [".jpeg", ".jpg", ".jfif"]; // Array of extensions
        ...
        for (const ext of extensions) {
            ...
            if (loaded) break; // If an image loaded, no need to check other extensions
        }
    }
}
